...
export default function ProfilePageClient({ token }) {
        ...
        <section className="pt-6 px-4 md:px-6">
          {user ? (
            <AnimatedCard
              title={
                user?.full_name ||
                "با تکمیل پروفایل، تجربه شخصی‌سازی شده بگیرید"
              }
            ...
            <div
              className={`relative overflow-hidden rounded-2xl p-8 bg-white/10 animate-pulse`}
            >
              {/* Simulated circle like animated card */}
              <div className="absolute top-0 left-0 w-64 h-64 rounded-full bg-white/20" />
              ...
              <div className="relative z-10 flex flex-col gap-4">
                ...
                {/* Children / progress placeholders */}
                <div className="flex items-center gap-2 mt-3">
